                                        ...
                                        <!-- Buttons for Actions -->
                                            <div class="btn-group dropstart">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <!-- Dropdown menu links -->
                                                    <li><a class="dropdown-item" href="/penduduk/detail/{{ $p->id }}">Detail Biodata</a></li>
                                                    <li><a class="dropdown-item" href="/penduduk/list/{{ $p->no_kk }}">List Keluarga</a></li>
                                                    <li>
                                                        <button class="dropdown-item btn-delete" data-id="{{ $p->id }}">Hapus Biodata</button>
                                                    </li>
                                                </ul>
                                             </div>
                                        </td>
