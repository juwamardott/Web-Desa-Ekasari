         ...
         <div class="container-fluid">
             <div class="row">
                 ...
                 <div class="col-sm-12 d-flex align-items-center">
                     <h5 class="mb-0">Data Jenis Surat</h5>
                     <div class="ms-auto block">
                        <a href="/jenis_surat/tambah" class="btn btn-primary btn-sm">Tambah Data</a>  
                    </div>
                 </div>                 
                                        ...
                                        <!-- Buttons for Actions -->
                                            <div class="btn-group dropstart">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <!-- Dropdown menu links -->
                                                    <li><a class="dropdown-item" href="/jenis_surat/detail/{{ $p->id }}">Detail Biodata</a></li>
                                                    <li>
