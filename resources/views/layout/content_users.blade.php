              ...
              <div class="row">
                  ...
                  <div class="col-sm-12 d-flex align-items-center">
                      ...
                      <div class="ms-auto block">
                         <a href="/user/tambah" class="btn btn-primary btn-sm">Tambah Data</a>
                     </div>
                  </div>
              ...
              <div class="row">
                  <div class="col-12">
                      ...
                      <div class="table-responsive">
                          ...
                          <div class="d-flex justify-content-center pagination-container-user">
 ...
 <script>
     $(document).ready(function () {
         function loadData(search,page = 1) {
          ...
          $('#loading').show();
             $.ajax({
                 url: "{{ route('user.filter') }}?page=" + page,
                 type: "GET",
                 data: { search: search},
                 success: function (data) {
                     $('#user-table-body').html(data.table);
                     $('.pagination-container-user').html(data.pagination);
